...
complete -c fujicli -n "__fish_fujicli_using_subcommand help; and not __fish_seen_subcommand_from device simulation backup image help" -f -a "device" -d 'Manage devices'
complete -c fujicli -n "__fish_fujicli_using_subcommand help; and not __fish_seen_subcommand_from device simulation backup image help" -f -a "simulation" -d 'Manage film simulations'
complete -c fujicli -n "__fish_fujicli_using_subcommand help; and not __fish_seen_subcommand_from device simulation backup image help" -f -a "backup" -d 'Manage backups'
complete -c fujicli -n "__fish_fujicli_using_subcommand help; and not __fish_seen_subcommand_from device simulation backup image help" -f -a "image" -d 'Manage and render images'
complete -c fujicli -n "__fish_fujicli_using_subcommand help; and not __fish_seen_subcommand_from device simulation backup image help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
